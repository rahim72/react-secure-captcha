...
function PopChild({ children, isPresent, anchorX, root }) {
  ...
  return (0, import_jsx_runtime3.jsx)(PopChildMeasure, { isPresent, childRef: ref, sizeRef: size, children: React2.cloneElement(children, { ref }) });
}
...
function MeasureLayout(props) {
  ...
  return (0, import_jsx_runtime7.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react24.useContext)(SwitchLayoutGroupContext), isPresent, safeToRemove });
}
...
var Captcha = ({
  ...
  const [key, setKey] = (0, import_react25.useState)(0);
  const refreshCaptcha = (0, import_react25.useCallback)(() => {
    if (type === "canvas") {
  ...
  const validateCaptcha = (0, import_react25.useCallback)(
    (value) => {
      const valid = type === "canvas" && value === captchaText || type === "math" && value === mathAnswer;
      if (valid) {
        import_sonner.toast.success(successMessage);
        setError(null);
        onValidate?.(true);
        return true;
      } else {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { className: `flex flex-col gap-3 w-full max-w-sm`, children: [
    ...
    !autoValidate && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      "button",
      {
        type: "button",
...
function useCaptcha(initialValue = "") {
  const [captcha, setCaptcha] = (0, import_react26.useState)(initialValue);
  const refresh = (0, import_react26.useCallback)((newValue) => {
    setCaptcha(newValue);
  }, []);
